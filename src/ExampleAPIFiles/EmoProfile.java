...
public class EmoProfile{
	static String path = "D:\\workspace2\\Service#2\\emotiv\\profile.emo";	//Amateur347
	
	//D:\\workspace2\\Test_BCI2\\EmotivUserProfile\\profile.emo
	//D:\\workspace2\\Service#2\\emotiv\\profile.emo
	
	public static void SaveProfile(){
		if(Edk.INSTANCE.IEE_SaveUserProfile(Variable.userID.getValue(), path) == EdkErrorCode.EDK_OK.ToInt()){
			System.out.println("All good");
		}
		System.out.println("EdkErrorCode.EDK_OK.ToInt() = "  + EdkErrorCode.EDK_OK.ToInt());
	}
	
	public static void LoadProfile(){
		if(Edk.INSTANCE.IEE_LoadUserProfile(Variable.userID.getValue(), path) == EdkErrorCode.EDK_OK.ToInt()){
			System.out.println("All good");
		}
		System.out.println("EdkErrorCode.EDK_OK.ToInt() = "  + EdkErrorCode.EDK_OK.ToInt());
	}
...
public class EmoProfileManagement {
    ...
    public static void SaveProfilesToFile()
    {
    	...
    	//	f.mkdir();
    	//}
    	String path = "D:\\workspace2\\Test_BCI2\\EmotivUserProfile";	//Amateur347
    	
    	for(int i = 0;i< userProfiles.size();i++)
    	{
    		UserProfile tmp =userProfiles.get(i);
    		ByteArrayToFile(path + "\\"+"profile.emo",tmp.profile.getBytes());
    	}
    ...
    public static void LoadProfilesFromFile()
    {
    	...
    	String mPath = "D:\\workspace2\\Test_BCI2\\EmotivUserProfile";	//Amateur347
    	File file = new File(mPath);
    ...
    /// </summary>
    public static boolean SaveCurrentProfile()
    {
    	try{
			...
			JOptionPane.showMessageDialog(new JFrame(), "Error - no data for save", "Error",
